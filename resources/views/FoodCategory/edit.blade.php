            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/foodCategories" class="button button2"><i class="fas fa-arrow-circle-left"></i> Back</a>
                    </div>

                    <div class="card-body">
                        <form action="/foodCategories/{{ $foodCategories->id }}" method="post">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label for="name">Name</label>
                                <input id="name" class="form-control" type="text" name="name" value="{{ $foodCategories->name }}"  required>
                            </div> 
                            @error('name')
