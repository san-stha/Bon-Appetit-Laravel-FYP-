            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/redeemReward" class="button button2"><i class="fas fa-arrow-circle-left"></i>
                            Back</a>
                    </div>

                    <div class="card-body">
                        <form action="/redeemReward/{{ $redeemRewards->id }}" method="post">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label for="finder">Finder <span class="text-danger">*</span></label>
                                <input id="finder" class="form-control" type="text" name="finder" required>
                            </div>
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <button type="submit" class="button button2">Update <i
