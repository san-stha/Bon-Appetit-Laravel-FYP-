                    ...
                    <div class="card-body">
                        <form action="/coupon/{{ $coupons->id }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="code" class="form-control" type="text" name="code" value="{{ $coupons->code }}">
                            </div> 

                            <div class="form-group">
                                <label for="percent_off">Percent_off</label>
                                <input id="percent_off" class="form-control" type="text" name="percent_off" value="{{ $coupons->percent_off }}">
                            </div> 
                            {{-- <div class="form-group">
                                <label for="value">Value</label>
                                <input id="value" class="form-control" type="text" name="value" value="{{ $coupons->value }}">
                            </div> 
                            <div class="form-group">
                                <label for="cart_value">Cart Value</label>
                                <input id="cart_value" class="form-control" type="text" name="cart_value" value="{{ $coupons->cart_value }}">
                            </div> --}}
                            ...
                            @enderror
                            <button type="submit" class="button button2">Update <i class="far fa-save"></i></button>
                        </form>
                    </div>
                </div>
            </div>
